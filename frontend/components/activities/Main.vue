...
const activities = ref([
  ...
  { id: 3, title: 'disco_bar', date: 'date.disco_bar', img: '/assets/img/new/disco_1.JPG', content: 'content.disco_bar' },
  { id: 4, title: 'restaurant', date: 'date.restaurant', img: '/assets/img/new/rest_1.JPG', content: 'content.restaurant' },
